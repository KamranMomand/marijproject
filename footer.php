...
{
    $proid=$_GET['proid'];
    $p_query = "SELECT * FROM `product_details` p join category c on p.category_id = c.cat_id join brands b on p.br_id = b.brand_id where p.product_status='active' && c.cat_id='$proid'";
}else{
    ...
    <div class="footer-bottom">
        <div class="container pt-0 pb-0">
            <div class="footer-bottom-content">
                <a href="shop.html"><img src="assets/images/blog/payment.jpg" alt="Image-HasTech"></a>
                    ...
                    <div class="row row-gutter-0">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="thumb-item">
                                                    <img src="assets/images/shop/details/m1.jpg" alt="Image" width="640"
                                                        height="710">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="thumb-item">
                                                    <img src="assets/images/shop/details/m2.jpg" alt="Image" width="640"
                                                        height="710">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="thumb-item">
                                                    <img src="assets/images/shop/details/m3.jpg" alt="Image" width="640"
                                                        height="710">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content pt-3">
                                ...
                                <p class="product-details-desc">Lorem ipsum dolor, sit amet consectetur adipisicing
                                    elit. Delectus, repellendus.</p>
                                ...
                                <div class="product-details-price">$550.00 <span class="price-old">$650.00</span>
                                </div>
