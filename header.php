                            ...
                            <ul class="main-nav">
                                ...
                                <li class="has-submenu position-static"><a href="#">Pages</a>
                                    <ul class="submenu-nav-mega">
                                        ...
                                        <li><a href="shop.php" class="mega-title">Categories</a>
                                            <ul>
                                                <?php
                                        ...
                                        <li><a href="shop.php" class="mega-title">Brands</a>
                                            <ul>
                                                <?php
                    ...
                    <div class="col-auto">
                        <div class="header-action">
                            ...
                            <button class="header-action-cart" type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvasWithCartSidebar" aria-controls="offcanvasWithCartSidebar"> 02
                                Items
