...
if(isset($_POST['btn-register'])){
    ...
    $regquery = "INSERT INTO `user`(`user_name`, `user_email`, `user_password`, `user_contact`, `user_address`) VALUES ('$username','$email','$password','$contact','$address')"; 
    $result = mysqli_query($conn, $regquery);

    if($result){
        $msg = "Register Successfuly";
    }else{
        $msg = "Register Not Successfuly";
    }
}
...
if(isset($_POST['btn-login'])){
    ...
    $regquery = "Select * from `user` where user_email = '$email' && user_password = '$password'"; 
    $result = mysqli_query($conn, $regquery);
                                ...
                                <div class="login-register-style login-register-pr">
                                    <form action="#" method="post">
                                        <div class="login-register-input">
                                            <input type="email" name="user-emaill" placeholder="Username or email address">
                                        </div>
                                        <div class="login-register-input">
